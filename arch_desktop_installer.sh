...
sudo pacman -S --noconfirm btop calibre cdrdao cups flatpak gimp git ifuse keepassxc magic-wormhole nmap pdfgrep rsync scribus strawberry tenacity tor ufw vim wget yt-dlp
