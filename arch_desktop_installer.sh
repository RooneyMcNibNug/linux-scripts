...
sudo pacman -S --noconfirm beets btop calibre cdrdao cups flatpak gimp git ifuse keepassxc magic-wormhole nmap okular pdfgrep rsync scribus strawberry tenacity tmux tor ufw vim wget yt-dlp
